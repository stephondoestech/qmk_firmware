...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |  '   |   /  |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | Alt  | GUI  | Menu | Left |    Space    |Right | Left |Down  |  Up  |Right |
   * `-----------------------------------------------------------------------------------'
   */
  [_BASE] = LAYOUT(
    ...
    KC_LCTL,  KC_LALT, KC_LGUI, KC_APP, MO(_LEFT),       KC_SPC,       MO(_RIGHT),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Del  | RGB  |RGBMO |      |      |             |      | Next | Vol- | Vol+ | Play |
   * `-----------------------------------------------------------------------------------'
   */
  [_LEFT] = LAYOUT(
    ...
    KC_DEL, RGB_TOG, RGB_MOD, _______, _______,     _______,      _______,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
  ),
